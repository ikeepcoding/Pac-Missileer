...
public class GameWonScreen implements  Screen {
    ...
    public GameWonScreen(final PacMan game) {
        this.game = game;
        ...
        table.add(playAgainLabel).expandX().padBottom(10); //row length expansion + padding
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.batch.draw(TextureManager.GAME_WON, 0,0, PacMan.G_WIDTH, PacMan.G_HEIGHT);
        game.batch.end();
